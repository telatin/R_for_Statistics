...
The data you need to complete the training exercises is in the accompanying file [Introstat.xlsx](./Introstat.xlsx).  All of the commands for the worked examples and the exercises is in the file TutorialScript.R.  The commands for the worked examples are also typed out here.
...
`r example("Installing a package")`
...
`r exercise("Tables, data frames and accessors")`
